...
\title{ Worst case scenario optimization }
...
\begin{itemize}
 \item Worst case scenario problems
 \item Worst case scenario: Linear constraint
 \item Worst case scenario: Quadratic constraint
 \item Max over norm of a sum of vectors
 \item Worst case scenario: Conic constraint
\item Homework
\end{itemize}
...
\begin{frame}{Worst case scenario problems}
...
\begin{frame}{Worst case scenario: Linear constraint}
...
\begin{frame}{Worst case scenario: Conic constraint}
%	\framesubtitle{Part 1}
	\begin{flushleft}
