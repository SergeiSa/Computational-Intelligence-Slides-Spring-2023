...
\begin{block}{Statement}
  A lot of modern methods, computations and algorithms are backed by numerical optimization tools.
\end{block}
...
\textcolor{black}{\qrcode[height=1.5in]{https://github.com/SergeiSa/Computational-Intelligence-Slides-Spring-2023}}
\bigskip
